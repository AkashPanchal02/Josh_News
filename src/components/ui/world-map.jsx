  ...
  return (
    (<div
      ...
      <div
        ...
        src={`data:img/svg+xml;utf8,${encodeURIComponent(svgMap)}`}
...
//   // Memoizing the map generation to prevent unnecessary recalculations
...
//   // Project geographic coordinates onto SVG coordinates
//   const projectPoint = (lat, lng) => {
//     return {
//       x: (lng + 180) * (800 / 360),
//       y: (90 - lat) * (400 / 180),
...
//       />
//       <svg ref={svgRef} viewBox="0 0 800 400" className="w-full h-full absolute inset-0">
//         {dots.map((dot, i) => {
//           const startPoint = projectPoint(dot.start.lat, dot.start.lng);
//           const endPoint = projectPoint(dot.end.lat, dot.end.lng);
//           return (
